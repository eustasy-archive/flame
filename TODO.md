...
- [x] Development docs moved to `CONTRIBUTING.md`: setting up, commands, how the parts fit together, the files, the tests, how to make common changes, and CI and Dependabot.
